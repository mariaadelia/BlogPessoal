package generation.blog.configuration;
...
public class SwaggerConfig {
	...
	private static Contact contact() {
		return new Contact("Maria Adélia de Campos", 
				"https://github.com/mariaadelia",
				"maria.adelia.contato@gmail.com");
	}
	...
	private static List<Response> responseMessageForGET(){
		return new ArrayList<Response>() {
			...
			
			{
				...
				.description("Operação realizada com sucesso!").build());
				...
				.description("Proibido o acesso!").build());
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("generation.blog.controller"))		
